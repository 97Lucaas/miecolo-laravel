...
<div class="fond">
    ...
    <img src="/assets/Group 100.png" class="z">
    <img src="/assets/Group 119.png" class="z_2">
...
<section>
    ...
    <section class="flex_img">
        ...
        <input class="submit-produit" type="submit" value="Voir la fiche technique" class="butt_tech">
    </section>
    
    <div class="flex_txt_case">
        <section class="bloc_ajout">
...
Pour connecter votre balance principale aux réseaux, un abonnement de 3€ HT/mois est nécessaire.
        </p>
    </div>
</div>
</section>
